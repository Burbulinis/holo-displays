...
public class HologramLinePickupLineEvent extends HologramLineEvent {
    private static final HandlerList HANDLERS = new HandlerList();

    public HologramLinePickupLineEvent(Player player, Hologram hologram, HologramLine hologramLine) {
